      ...
      <div className="bg-light rounded-3 shadow-lg">
        ...
        <div className="d-lg-block collapse pb-2" id="account-menu">
          <h3 className="d-block bg-secondary fs-sm fw-semibold text-muted mb-0 px-4 py-3">Dashboard</h3>
            <a className="d-flex align-items-center nav-link-style px-4 py-3" href="dashboard-orders.html"><i className="ai-shopping-bag fs-lg opacity-60 me-2"></i>Workouts{/* <span className="nav-indicator"></span> */}<span className="text-muted fs-sm fw-normal ms-auto">2</span></a>
